# -*- coding: utf-8 -*-
"""
Created on Wed Dec 27 11:22:36 2017
fuction:基于车牌底色-蓝色（或黄色，人工设定）的颜色识别
@author: liqilv
"""
...
def findPlateNumberRegion(img):
    ...
    # 第三个参   数是轮廓近似方法，cv2.CHAIN_APPROX_SIMPLE意味着最紧要描述轮廓的信息
...
def detect(img):    
    ...
    # 形态学变换的预处理
    dilation = colorDetect(img,option=0)
...
#print "b通道的直方图值",bhist
    ...
    for i in range(0,256):
        if key < rhist[i] :
            key = rhist[i]
            rmax = i
    print "the hist value of rgb:",gmax,rmax,bmax
...
def xianshi(img):
    ...
    print "the hist value of hsv/car color:",hs,ss,vs,ys
    #return ys
